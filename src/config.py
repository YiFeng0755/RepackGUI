...
class ConfigParse(object):
    ...
    def initData(self,jsonStr):
        ...
        self.__logDir = jsonData['logDir']
        self.__keystore = jsonData['keystore']
        self.__packageName = jsonData['packageName']
        self.__saveLog = jsonData['saveLog']
        self.__saveFile = jsonData['saveFile']
        self.__timestamp = jsonData['timestamp']
    ...
    def setCurrentSubProcess(self, process):
        self.currentSubProcess = process
        
    def getCurrentSubProcess(self):
        return self.currentSubProcess
